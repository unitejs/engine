...
export declare class Angular extends SharedAppFramework {
    ...
    toggleDependencies(logger: ILogger, fileSystem: IFileSystem, uniteConfiguration: UniteConfiguration, engineVariables: EngineVariables): void;
}
