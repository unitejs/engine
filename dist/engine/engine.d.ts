...
export declare class Engine implements IEngine {
    ...
    private clientPackageAdd(packageName, version, preload, includeMode, testScriptInclude, main, mainMinified, isPackage, assets, outputDirectory, uniteConfiguration);
