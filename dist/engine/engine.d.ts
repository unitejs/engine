...
export declare class Engine implements IEngine {
    ...
    private loadConfiguration(outputDirectory, profileSource, profile, force);
    private loadProfile<T>(profileSource, profile);
    private configureRun(outputDirectory, uniteConfiguration, license, force);
    private clientPackageAdd(packageName, version, preload, includeMode, scriptIncludeMode, main, mainMinified, testingAdditions, isPackage, assets, map, loaders, noScript, profile, outputDirectory, uniteConfiguration);
