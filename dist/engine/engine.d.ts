...
export declare class Engine implements IEngine {
    ...
    clientPackage(operation: ModuleOperation | undefined | null, packageName: string | undefined | null, version: string | undefined | null, preload: boolean, outputDirectory: string | undefined | null): Promise<number>;
    ...
    private clientPackageAdd(packageName, version, preload, outputDirectory, uniteConfiguration);
