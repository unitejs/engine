...
import * as webdriver from "gulp-webdriver";
...
let seleniumInstance: selenium.SeleniumInstance = null;
let browserSyncInstance: browserSync.BrowserSyncInstance = null;
...
gulp.task("e2e-serve", async () => {
    ...
    try {
        const opts: selenium.StartOptions = {drivers: {}};
        opts.drivers[options.browser] = {};
        seleniumInstance = await util.promisify<selenium.StartOptions, selenium.SeleniumInstance>(selenium.start)(opts);
    } catch (err) {
