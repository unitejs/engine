...
async function execCordova(args, cwd) {
...
function getImageResources() {
    ...
    images.android = [
        ...
        // Splash
        {
            name: "screen-land-ldpi.png",
            width: 320,
            height: 200,
            density: "land-ldpi"
        },
        {
            name: "screen-land-mdpi.png",
            width: 480,
            height: 320,
            density: "land-mdpi"
        },
        {
            name: "screen-land-hdpi.png",
            width: 800,
            height: 480,
            density: "land-hdpi"
        },
        {
            name: "screen-land-xhdpi.png",
            width: 1280,
            height: 720,
            density: "land-xhdpi"
        },
        {
            name: "screen-land-xxhdpi.png",
            width: 1600,
            height: 960,
            density: "land-xxhdpi"
        },
        {
            name: "screen-land-xxxhdpi.png",
            width: 1920,
            height: 1280,
            density: "land-xxxhdpi"
        },
        {
            name: "screen-port-ldpi.png",
            width: 200,
            height: 320,
            density: "port-ldpi"
        },
        {
            name: "screen-port-mdpi.png",
            width: 320,
            height: 480,
            density: "port-mdpi"
        },
        {
            name: "screen-port-hdpi.png",
            width: 480,
            height: 800,
            density: "port-hdpi"
        },
        {
            name: "screen-port-xhdpi.png",
            width: 720,
            height: 1280,
            density: "port-xhdpi"
        },
        {
            name: "screen-port-xxhdpi.png",
            width: 960,
            height: 1600,
            density: "port-xxhdpi"
        },
        {
            name: "screen-port-xxxhdpi.png",
            width: 1280,
            height: 1920,
    ...
    images.ios = [
        ...
        {
            name: "AppIcon24x24@2x.png",
            size: 48
        },
        {
            name: "AppIcon27.5x27.5@2x.png",
            size: 55
        },
        {
        ...
        {
            name: "AppIcon44x44@2x.png",
            size: 88
        },
        {
            name: "AppIcon86x86@2x.png",
            size: 172
        },
        {
            name: "AppIcon98x98@2x.png",
            size: 196
        },
        // Splash
        {
    ...
    images.windows = [
        ...
        {
            name: "Square44x44Logo.scale-140.png",
            size: 62
        },
        {
        ...
        {
            name: "Square44x44Logo.scale-240.png",
            size: 106
        },
        {
        ...
        {
            name: "Square30x30Logo.scale-100.png",
            size: 30
        },
        {
            name: "Square70x70Logo.scale-100.png",
            size: 70
        },
        {
        ...
        {
            name: "Square71x71Logo.scale-140.png",
            size: 99
        },
        {
        ...
        {
            name: "Square71x71Logo.scale-240.png",
            size: 170
        },
        {
        ...
        {
            name: "Square150x150Logo.scale-140.png",
            size: 210
        },
        {
        ...
        {
            name: "Square150x150Logo.scale-240.png",
            size: 360
        },
        {
        ...
        {
            name: "Square310x310Logo.scale-140.png",
            size: 434
        },
        {
        ...
        {
            name: "Square310x310Logo.scale-180.png",
            size: 558
        },
        {
        ...
        {
            name: "Wide310x150Logo.scale-80.png",
            width: 248,
            height: 120
        },
        {
        ...
        {
            name: "Wide310x150Logo.scale-140.png",
            width: 434,
            height: 210
        },
        {
        ...
        {
            name: "Wide310x150Logo.scale-180.png",
            width: 558,
            height: 270
        },
        {
        ...
        {
            name: "Wide310x150Logo.scale-240.png",
            width: 744,
            height: 360
        },
        {
        ...
        {
            name: "SplashScreen.scale-140.png",
            width: 868,
            height: 420
        },
        {
        ...
        {
            name: "SplashScreen.scale-180.png",
            width: 1116,
            height: 540
        },
        {
        ...
        {
            name: "SplashScreenPhone.scale-240.png",
            width: 1152,
            height: 1920
        },
        {
            name: "SplashScreenPhone.scale-140.png",
            width: 672,
            height: 1120
        },
        {
            name: "SplashScreenPhone.scale-100.png",
            width: 480,
            height: 800
        }
    ];
...
gulp.task("platform-cordova-clean", async () => {
    ...
    const toClean = [
        path.join("../", uniteConfig.dirs.platformRoot, "/cordova/www/**/*")
    ];
...
gulp.task("platform-cordova-update-config", async () => {
    try {
        ...
        const xmlOptions = {};
        const xml = await util.promisify(xml2js.parseString)(cordovaConfigXml.toString(), xmlOptions);
        xml.widget.$.id = "";
        ...
        if (!projExists) {
            const projContent = await util.promisify(fs.readFile)(path.join(uniteConfig.dirs.www.build, "/assets/platform/cordova/cordova.jsproj"));
...
gulp.task("platform-cordova-create-platforms", async () => {
    try {
        ...
        if (fileExists) {
            const platforms = await util.promisify(fs.readFile)(platformsFile);
            currentPlatforms = JSON.parse(platforms.toString());
        }
        const cordovaFolder = path.join("../", uniteConfig.dirs.platformRoot, "cordova");
...
gulp.task("platform-cordova-gather", async () => {
    ...
    const indexContentBuffer = await util.promisify(fs.readFile)(indexFilename);
    let indexContent = indexContentBuffer.toString();
    const headTag = "</head>";
...
gulp.task("platform-cordova-dev", async () => {
    try {
        await util.promisify(runSequence)("platform-cordova-clean", "platform-cordova-create", "platform-cordova-update-config", "platform-cordova-gather", "platform-cordova-create-platforms", "platform-cordova-save");
    } catch (err) {
        display.error("Unhandled error during task", err);
        process.exit(1);
    }
