...
describe("PipelineStepBase", () => {
    ...
    describe("initialise", () => {
        it("can be called", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.initialise(loggerStub, fileSystemStub, uniteConfigurationStub, engineVariablesStub);
    ...
    describe("uninstall", () => {
        it("can be called", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.uninstall(loggerStub, fileSystemStub, uniteConfigurationStub, engineVariablesStub);
            Chai.expect(res).to.be.equal(0);
        });
    });
    ...
    describe("finalise", () => {
        it("can be called", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.finalise(loggerStub, fileSystemStub, uniteConfigurationStub, engineVariablesStub);
            Chai.expect(res).to.be.equal(0);
        });
    });
    ...
    describe("copyFile", () => {
        it("can be called when sourceFile does not exist", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.copyFile(loggerStub, fileSystemStub, "./test/unit/temp/", "sourceFile.txt", "./test/unit/temp/", "destFile.txt", false);
    ...
    describe("deleteFileText", () => {
        it("can be called when file does not exist", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.deleteFileText(loggerStub, fileSystemStub, "./test/unit/temp/", "file.txt", false);
            Chai.expect(res).to.be.equal(0);
        });
    ...
    describe("deleteFileLines", () => {
        it("can be called when file does not exist", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.deleteFileLines(loggerStub, fileSystemStub, "./test/unit/temp/", "file.txt", false);
            Chai.expect(res).to.be.equal(0);
        });
    ...
    describe("deleteFileJson", () => {
        it("can be called when file does not exist", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.deleteFileJson(loggerStub, fileSystemStub, "./test/unit/temp/", "file.json", false);
            Chai.expect(res).to.be.equal(0);
        });
    ...
    describe("createFolder", () => {
        it("can be called", async () => {
            const obj = new TestPipelineStep();
            const res = await obj.createFolder(loggerStub, fileSystemStub, "./test/unit/temp/blah");
            Chai.expect(res).to.be.equal(0);
    ...
    describe("deleteFolder", () => {
        it("can fail when it throws an exception", async () => {
            ...
            const obj = new TestPipelineStep();
            const res = await obj.deleteFolder(loggerStub, fileSystemStub, "./test/unit/temp/blah", true);
            Chai.expect(res).to.be.equal(1);
        });
        ...
        it("can be called when folder exists and not forced", async () => {
            await fileSystemStub.directoryCreate("./test/unit/temp/blah");
            const obj = new TestPipelineStep();
            const res = await obj.deleteFolder(loggerStub, fileSystemStub, "./test/unit/temp/blah", false);
            Chai.expect(res).to.be.equal(0);
